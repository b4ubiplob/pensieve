...
# Pensieve Application Startup Script - DEV MODE
# This script runs backend and frontend in development mode (hot reload)
...
echo "========================================"
echo "Starting Pensieve Application (DEV MODE)"
echo "========================================"
...
# Start Backend
echo "========================================"
echo "Starting Backend Server (Maven)"
echo "========================================"
cd pensieve
